...
import type { useDashboardCategoryTree } from "@/app/dashboard/hooks";

import { useDashboardState } from "@/app/dashboard/hooks";
import {
...
import { computeNextOrderedCategoryLabels } from "@/app/dashboard/services/category";
import { INITIAL_CATEGORIES } from "@/app/dashboard/services/dashboard-constants";
