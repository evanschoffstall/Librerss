...
export const DEV_PLACEHOLDER_ARTICLES: Article[] = [
  {
    ...
    publicationDate: new Date(Date.now() - 18 * MINUTE),
    lastChecked: new Date(Date.now() - 5 * MINUTE),
    feedId: 0,
  },
  {
    id: -2,
    ...
    publicationDate: new Date(Date.now() - 42 * MINUTE),
    lastChecked: new Date(Date.now() - 6 * MINUTE),
    feedId: 0,
  },
  {
    id: -3,
    ...
    publicationDate: new Date(Date.now() - 95 * MINUTE),
    lastChecked: new Date(Date.now() - 11 * MINUTE),
    feedId: 0,
  },
  {
    id: -4,
    ...
    publicationDate: new Date(Date.now() - 2 * 60 * MINUTE),
    lastChecked: new Date(Date.now() - 14 * MINUTE),
    feedId: 0,
  },
  {
    id: -5,
    ...
    publicationDate: new Date(Date.now() - 4 * 60 * MINUTE),
    lastChecked: new Date(Date.now() - 17 * MINUTE),
    feedId: 0,
  },
  {
    id: -6,
    ...
    publicationDate: new Date(Date.now() - 7 * 60 * MINUTE),
    lastChecked: new Date(Date.now() - 25 * MINUTE),
    feedId: 0,
  },
];
