...
export function DashboardShellSkeleton() {
  return (
    ...
    >
      <div className="relative flex h-full justify-center overflow-hidden px-4 pb-[env(safe-area-inset-bottom)] pt-[calc(env(safe-area-inset-top)+3.8rem)] md:px-6">
        <div
          aria-hidden="true"
          className="pointer-events-none absolute top-1/2 size-64 -translate-y-1/2 rounded-full bg-primary/5 blur-3xl"
        />
        <div className="relative flex h-full w-full max-w-6xl flex-col gap-1 overflow-hidden">
