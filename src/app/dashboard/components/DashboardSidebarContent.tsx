...
const sidebarPanelCls = "space-y-4 pr-3 anim-fade-in-load-slow";
          ...
          {sidebarCategories.length === 0 ? (
            ...
            sidebarCategories.map((categoryNode: CategoryTreeNode, index) => (
              <div
                ...
                className={`space-y-1 anim-fade-in-load-slow ${ANIM_TRANSITION_OPACITY} ${isSidebarVisible ? "opacity-100" : "opacity-0"
                  }`}
                style={{
