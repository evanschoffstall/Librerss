...
} from "@/app/dashboard/components/feed-view/feed-list-surface-state/useInvertedExpansionScrollLockContracts";
import type {
  ArticleViewportSnapshot,
  CollapsingArticles,
} from "@/app/dashboard/display-types";

import { useInvertedExpansionLockMachine } from "@/app/dashboard/components/feed-view/feed-list-surface-state/useInvertedExpansionLockMachine";
import { useInvertedExpansionScrollLockEvents } from "@/app/dashboard/components/feed-view/feed-list-surface-state/useInvertedExpansionScrollLockEvents";
import {
