import type { SettingsCategoryFeedListProps } from "@/app/dashboard/components/settings-dialog/SettingsCategoryFeedContracts";

import { SettingsFeedRow } from "@/app/dashboard/components/settings-dialog/SettingsFeedRow";

export type { SettingsCategoryFeedListProps } from "@/app/dashboard/components/settings-dialog/SettingsCategoryFeedContracts";
