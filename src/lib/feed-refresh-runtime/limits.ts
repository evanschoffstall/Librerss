...
/**
 * Clamp per-feed upstream request timeouts in constrained serverless runtimes.
 * @param configuredTimeoutMs - Configured upstream request timeout.
 * @param environment - Environment variables used for runtime detection.
 * @returns The effective upstream request timeout in milliseconds.
 */
